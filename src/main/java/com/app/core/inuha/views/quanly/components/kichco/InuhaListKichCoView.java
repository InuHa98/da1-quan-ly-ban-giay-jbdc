package com.app.core.inuha.views.quanly.components.kichco;

import com.app.core.inuha.views.quanly.components.degiay.*;
...
public class InuhaListKichCoView extends javax.swing.JPanel {
    ...
    private final InuhaKichCoService kichCoService = new InuhaKichCoService();
