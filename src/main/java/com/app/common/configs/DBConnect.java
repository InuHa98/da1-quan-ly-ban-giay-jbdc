...
public class DBConnect {
    ...
    private final static String HOSTNAME = System.getProperty("DB_HOSTNAME");

    private final static String PORT = System.getProperty("DB_PORT");

    private final static String DATABASE = System.getProperty("DB_DATABASE");

    private final static String USERNAME = System.getProperty("DB_USERNAME");
